    ...
    <x-slot name="header">
        <div class="page-header">
            <div>
                ...
                <p class="page-sub">Record outgoing stock for {{ auth()->user()->activeBranch()?->name }}</p>
            </div>
        </div>
    </x-slot>
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('stock.out.store') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="reference_number" name="reference_number" value="{{ old('reference_number') }}" placeholder="e.g. ISS-2026-001">
