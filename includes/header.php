...
<aside class="sidebar" id="sidebar">
    ...
    $reportsOpen = in_array($sidebarActivePage, ['analytics', 'reports', 'audit'], true);
    ?>
    <nav class="sidebar-nav">
        <ul>
            ...
            <li class="nav-dropdown <?= $inventoryOpen ? 'open' : '' ?>">
                <button type="button" class="nav-dropdown-toggle" onclick="this.closest('.nav-dropdown').classList.toggle('open')" aria-expanded="<?= $inventoryOpen ? 'true' : 'false' ?>">
                ...
                <ul class="nav-submenu">
                    <li class="<?= $sidebarActivePage === 'items' ? 'active' : '' ?>">
                        <a href="<?= BASE_URL ?>pages/items.php">
                            <span class="nav-icon"><svg viewBox="0 0 24 24"><path d="M21 16V8a2 2 0 00-1-1.73l-7-4a2 2 0 00-2 0l-7 4A2 2 0 003 8v8a2 2 0 001 1.73l7 4a2 2 0 002 0l7-4A2 2 0 0021 16z"/></svg></span>
                            Inventory Items
                        </a>
                    </li>
                    <li class="<?= $sidebarActivePage === 'categories' ? 'active' : '' ?>">
            ...
            <li class="nav-dropdown <?= $stockOpen ? 'open' : '' ?>">
                ...
                <ul class="nav-submenu">
                    <li class="<?= $sidebarActivePage === 'stock_in' ? 'active' : '' ?>">
                    ...
                    <li class="<?= $sidebarActivePage === 'stock_out' ? 'active' : '' ?>">
            ...
            <li class="nav-dropdown <?= $managementOpen ? 'open' : '' ?>">
                <button type="button" class="nav-dropdown-toggle" onclick="this.closest('.nav-dropdown').classList.toggle('open')" aria-expanded="<?= $managementOpen ? 'true' : 'false' ?>">
                    <span class="nav-icon"><svg viewBox="0 0 24 24"><path d="M16 21v-2a4 4 0 00-4-4H6a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 00-3-3.87"/><path d="M16 3.13a4 4 0 010 7.75"/></svg></span>
                    <span>Management</span>
                    <svg viewBox="0 0 24 24" class="dropdown-chevron"><polyline points="6 9 12 15 18 9"/></svg>
                </button>
                <ul class="nav-submenu">
                    <li class="<?= $sidebarActivePage === 'suppliers' ? 'active' : '' ?>">
                    ...
                    <li class="<?= $sidebarActivePage === 'requests' ? 'active' : '' ?>">
                    ...
                    <li class="<?= $sidebarActivePage === 'procurement' ? 'active' : '' ?>">
                        <a href="<?= BASE_URL ?>pages/procurement.php">
                            <span class="nav-icon"><svg viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="16" rx="2"/><path d="M7 8h10"/><path d="M7 12h10"/><path d="M7 16h6"/></svg></span>
                            Procurement
                        </a>
                    </li>
                    <li class="<?= $sidebarActivePage === 'maintenance' ? 'active' : '' ?>">
                    ...
                    <li class="<?= $sidebarActivePage === 'transfers' ? 'active' : '' ?>">
                    ...
                    <li class="<?= $sidebarActivePage === 'users' ? 'active' : '' ?>">
                    ...
                    <li class="<?= $sidebarActivePage === 'sections' ? 'active' : '' ?>">
                    ...
                    <?php endif; ?>
                    <?php if (hasRole('Administrator')): ?>
                    <li class="<?= $sidebarActivePage === 'departments' ? 'active' : '' ?>">
                    ...
                    <li class="<?= $sidebarActivePage === 'settings' ? 'active' : '' ?>">
